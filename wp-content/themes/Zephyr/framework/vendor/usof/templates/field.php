...
if ( $field['type'] == 'group' ) {
	...
	echo '<div class="usof-form-group" data-name="' . $name . '"';
	echo 'style="display: ' . ( $show_field ? 'block' : 'none' ) . '">';

	// Start of repeatable part
//	echo '<div class="usof-form-wrapper" data-name="' . $name . '" data-id="' . $id . '">';
//	echo '<div class="usof-form-wrapper-cont"> All options go here </div>';
//	echo '<div class="usof-form-group-delete">Delete Group</div>';
//	echo '</div>';
	// End of repeatable part
	echo '<div class="usof-form-group-add">Add Group</div>';
	echo '</div>';
